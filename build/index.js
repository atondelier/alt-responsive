...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.create_responsive_store = create_responsive_store;
	...
	var _responsiveStore = __webpack_require__(2);
	
	var _responsiveStore2 = _interopRequireDefault(_responsiveStore);
	...
	function create_responsive_store(breakpoints, innerWidthGetter) {
	    if (breakpoints === undefined) breakpoints = default_breakpoints;
	
	    // add `infinity` breakpoint for upper bound
	    breakpoints.infinity = Infinity;
	    // return the store
	
	    var ConfiguredResponsiveStore = (function (_ResponsiveStore) {
	        _inherits(ConfiguredResponsiveStore, _ResponsiveStore);
	
	        function ConfiguredResponsiveStore() {
	            _classCallCheck(this, ConfiguredResponsiveStore);
	
	            _get(Object.getPrototypeOf(ConfiguredResponsiveStore.prototype), 'constructor', this).apply(this, arguments);
	        }
	
	        _createClass(ConfiguredResponsiveStore, [{
	            key: 'get_breakpoints',
	            value: function get_breakpoints() {
	                return breakpoints;
	            }
	        }, {
	            key: 'get_inner_width',
	            value: function get_inner_width() {
	                if (typeof innerWidthGetter === 'function') {
	                    return innerWidthGetter.apply(this, arguments);
	                }
	                return _get(Object.getPrototypeOf(ConfiguredResponsiveStore.prototype), 'get_inner_width', this).call(this);
	            }
	        }]);
	
	        return ConfiguredResponsiveStore;
	    })(_responsiveStore2['default']);
	
	    ConfiguredResponsiveStore.displayName = _responsiveStore2['default'].displayName;
	
	    return ConfiguredResponsiveStore;
	}
	
	// by default, export a ResponsiveStore with the default breakpoints
	exports['default'] = create_responsive_store();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ResponsiveStore = (function () {
	    function ResponsiveStore() {
	        var _this = this;
	
	        _classCallCheck(this, ResponsiveStore);
	
	        // create media queries out of the breakpoints
	        this.media_queries = _mediaquery2['default'].asObject(this.get_breakpoints());
	
	        // set the initial store state
	
	        // the current width of the browser
	        var browser_width = this.get_inner_width();
	        ...
	        window.addEventListener('resize', (0, _lodash.throttle)(function () {
	            // the current width of the browser
	            var width = _this.get_inner_width();
	            // update the store state
	            _this.setState({
	                browser_width: width,
	                current_media_type: _this.get_current_media_type(width),
	                browser_less_than: _this.get_less_than(width),
	                browser_greater_than: _this.get_greater_than(width)
	            });
	        }), 100);
	    }
	
	    _createClass(ResponsiveStore, [{
	        key: 'get_breakpoints',
	        value: function get_breakpoints() {
	            return {};
	        }
	        ...
	        key: 'get_less_than',
	        value: function get_less_than(browser_width) {
	            return (0, _lodash.transform)(this.get_breakpoints(), function (result, breakpoint, media_type) {
	        ...
	        key: 'get_greater_than',
	        value: function get_greater_than(browser_width) {
	            return (0, _lodash.transform)(this.get_breakpoints(), function (result, breakpoint, media_type) {
	                // if the breakpoint is a number
	                if (typeof breakpoint === 'number') {
	                    // store wether or not it is less than the breakpoint
	        ...
	        key: 'get_current_media_type',
	        value: function get_current_media_type() {
	            var _this2 = this;
	
	            // loop over the keys of the media query
	            return (0, _lodash.keys)(this.media_queries).reduce(function (final_type, current_type) {
	                // grab the corresponding query string
	                var query_string = _this2.media_queries[current_type];
	...
	exports['default'] = ResponsiveStore;
